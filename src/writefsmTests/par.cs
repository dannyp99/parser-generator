...
rule = new RGrule("E");
rule.RuleAction = (pstack) => {  Expr e2 = (Expr)pstack.Pop().Value; pstack.Pop();  Expr e1 = (Expr)pstack.Pop().Value; return new Plus(e1,e2); };
parser1.Rules.Add(rule);
rule = new RGrule("E");
rule.RuleAction = (pstack) => {  Expr e2 = (Expr)pstack.Pop().Value; pstack.Pop();  Expr e1 = (Expr)pstack.Pop().Value; return new Minus(e1,e2); };
parser1.Rules.Add(rule);
rule = new RGrule("E");
rule.RuleAction = (pstack) => {  Expr e2 = (Expr)pstack.Pop().Value; pstack.Pop();  Expr e1 = (Expr)pstack.Pop().Value; return new Times(e1,e2); };
parser1.Rules.Add(rule);
rule = new RGrule("E");
rule.RuleAction = (pstack) => {  Expr e = (Expr)pstack.Pop().Value; pstack.Pop(); return new Negative(e); };
parser1.Rules.Add(rule);
rule = new RGrule("E");
