...
{
Parser<object> parser1 = new Parser<object>(testFSM,testRules);
GrammarRule rule = new GrammarRule("start");
rule = GrammarRule("E");
rule.Action = (pstack) => {  object t =pstack.Pop();pstack.Pop(); object e =pstack.Pop();{ return e+t; };
parser1.Rules.Add(rule);
rule = GrammarRule("E");
rule.Action = (pstack) => {  object t =pstack.Pop();{ return t; };
parser1.Rules.Add(rule);
rule = GrammarRule("T");
rule.Action = (pstack) => {  object f =pstack.Pop();pstack.Pop(); object t =pstack.Pop();{ return t*f; };
parser1.Rules.Add(rule);
rule = GrammarRule("T");
rule.Action = (pstack) => {  object f =pstack.Pop();{ return f; };
parser1.Rules.Add(rule);
rule = GrammarRule("F");
rule.Action = (pstack) => { pstack.Pop(); object e =pstack.Pop();pstack.Pop();{ return e; };
parser1.Rules.Add(rule);
rule = GrammarRule("F");
rule.Action = (pstack) => {  object n =pstack.Pop();{ return n; };
parser1.Rules.Add(rule);
rule = GrammarRule("START");
rule.Action = (pstack) => { pstack.Pop(); object e =pstack.Pop();return default(object);
parser1.Rules.Add(rule);
...
parser1.RSM[1].Add("EOF",new Shift());
parser1.RSM[2].Add("+",new Reduce(1));
parser1.RSM[2].Add("EOF",new Reduce());
parser1.RSM[2].Add("*",new Shift(8));
parser1.RSM[3].Add("*",new Reduce(3));
parser1.RSM[3].Add("+",new Reduce(3));
parser1.RSM[3].Add("EOF",new Reduce());
...
parser1.RSM[5].Add("+",new Reduce(5));
parser1.RSM[5].Add("EOF",new Reduce());
...
parser1.RSM[14].Add("EOF",new Reduce());
parser1.RSM[14].Add("*",new Shift(8));
parser1.RSM[15].Add("*",new Reduce(2));
parser1.RSM[15].Add("+",new Reduce(2));
parser1.RSM[15].Add("EOF",new Reduce());
...
parser1.RSM[17].Add("+",new Reduce(4));
parser1.RSM[17].Add("EOF",new Reduce());
