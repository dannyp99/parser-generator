...
rule = new RGrule("E");
rule.RuleAction = (pstack) => {  Console.WriteLine("Trying to return Val"); Expr n = (Expr)pstack.Pop().Value; return n; };
parser1.Rules.Add(rule);
rule = new RGrule("E");
rule.RuleAction = (pstack) => {  Console.WriteLine("Trying to Plus"); Expr e2 = (Expr)pstack.Pop().Value; pstack.Pop();  Expr e1 = (Expr)pstack.Pop().Value; return Val.Plus(e1,e2); };
parser1.Rules.Add(rule);
rule = new RGrule("E");
rule.RuleAction = (pstack) => {  Console.WriteLine("Trying to Minus");Expr e2 = (Expr)pstack.Pop().Value; pstack.Pop();  Expr e1 = (Expr)pstack.Pop().Value; return Val.Minus(e1,e2); };
parser1.Rules.Add(rule);
rule = new RGrule("E");
rule.RuleAction = (pstack) => {  Console.WriteLine("Trying to Times");Expr e2 = (Expr)pstack.Pop().Value; pstack.Pop();  Expr e1 = (Expr)pstack.Pop().Value; return Val.Times(e1,e2); };
parser1.Rules.Add(rule);
rule = new RGrule("E");
rule.RuleAction = (pstack) => {  Console.WriteLine("Trying to Negative");Expr e = (Expr)pstack.Pop().Value; pstack.Pop(); return Val.Negative(e); };
parser1.Rules.Add(rule);
rule = new RGrule("E");
rule.RuleAction = (pstack) => { Console.WriteLine("Trying to return Expr");pstack.Pop();  Expr e = (Expr)pstack.Pop().Value; pstack.Pop(); return e; };
parser1.Rules.Add(rule);
rule = new RGrule("START");
rule.RuleAction = (pstack) => { Console.WriteLine("Trying to Plus");pstack.Pop(); pstack.Pop(); return default(object);};
parser1.Rules.Add(rule);
